...
class HospitalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hospital" do
    assert_difference('Hospital.count') do
      post hospitals_url, params: { hospital: { about: @hospital.about, address: @hospital.address, latitude: @hospital.latitude, longitude: @hospital.longitude, name: @hospital.name, phone: @hospital.phone } }
    end
  ...
  test "should update hospital" do
    patch hospital_url(@hospital), params: { hospital: { about: @hospital.about, address: @hospital.address, latitude: @hospital.latitude, longitude: @hospital.longitude, name: @hospital.name, phone: @hospital.phone } }
